    ...
    <!-- banner -->
        ...
        <div class="product tea">
            <ul>
                ...
                <li>
                    <div class="introduce"> <h1><ion-icon name="leaf-outline"></ion-icon>純茶系列</h1>
        ...
        <div class="product juice">
            ...
            <div class="introduce">
                <h1><ion-icon name="leaf-outline"></ion-icon>水果茶系列</h1>
        ...
        <div class="product coffee">
            ...
            <div class="introduce">
                <h1><ion-icon name="leaf-outline"></ion-icon>咖啡系列</h1>
        ...
        <div class="product smoothies">
            ...
            <div class="introduce">
                <h1><ion-icon name="leaf-outline"></ion-icon>冰沙系列</h1>
